...
import { uploadProfile } from "../Api/UploadApiUsingCloudinary"; // Import the uploadProfile function
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 dark:bg-gray-800 py-2 border border-slate-400  dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-shadow bg-white text-gray-900 dark:text-white placeholder-gray-500"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 border rounded-lg bg-gray-100 border-slate-400  dark:border-slate-700 text-gray-500 cursor-not-allowed dark:bg-gray-700 dark:text-gray-400 focus:ring-0 focus:border-gray-300"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="4"
                            className="w-full px-4 dark:bg-gray-800 py-2 border rounded-lg border-slate-400  dark:border-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-shadow bg-white text-gray-900 dark:text-white placeholder-gray-500"
                        ></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 dark:bg-gray-800 py-2 border rounded-lg border-slate-400  dark:border-slate-700 :ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-shadow bg-white text-gray-900 dark:text-white placeholder-gray-500"
                        />
                    </div>
                </div>
            </div>
